...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <input id="background_colour" name="background_colour" type="color" required="required" value="#000000" class="form-control">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <input id="exit_button_bg" name="exit_button_bg" type="color" required="required" value="#000000" class="form-control">
            <small>#XXXXXX (background)</small>
        </div>
        <div class="col-lg-4">
            <input id="exit_button_fg" name="exit_button_fg" type="color" required="required" value="#000000" class="form-control">
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-2">
            <input id="button1_bg" name="button1_bg" type="color" required="required" value="#000000" class="form-control">
            <small>B1 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button2_bg" name="button2_bg" type="color" required="required" value="#000000" class="form-control">
            <small>B2 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button3_bg" name="button3_bg" type="color" required="required" value="#000000" class="form-control">
            <small>B3 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button4_bg" name="button4_bg" type="color" required="required" value="#000000" class="form-control">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-2">
            <input id="button1_fg" name="button1_fg" type="color" required="required" value="#000000" class="form-control">
            <small>B1 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button2_fg" name="button2_fg" type="color" required="required" value="#000000" class="form-control">
            <small>B2 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button3_fg" name="button3_fg" type="color" required="required" value="#000000" class="form-control">
            <small>B3 #XXXXXX</small>
        </div>
        <div class="col-lg-2">
            <input id="button4_fg" name="button4_fg" type="color" required="required" value="#000000" class="form-control">
            <small>B4 #XXXXXX</small>
        </div>
    </div>
