    ...
    <div class="container">
        ...
        <div class="nav-collapse collapse navbar-responsive-collapse">
            <ul class="nav navbar-nav">
                <li <?php if(Request::$current->controller() == 'Users'): ?>class="active"<?php endif ?>><a href="<?php echo URL::site('participants')?>">Participants</a></li>
                <li <?php if(Request::$current->controller() == 'Images'): ?>class="active"<?php endif ?>><a href="<?php echo URL::site('images') ?>">Images</a></li>
